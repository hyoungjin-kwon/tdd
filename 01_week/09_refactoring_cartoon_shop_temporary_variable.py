...
def get_result(order_histories, cartoon_info):
    ...
    for order_history in order_histories:
        ...
        result += f"총액 {calculate_total_amount_from_histories(cartoon_info, order_history)}원 "  # 출력 결과 추가하기
        result += f"적립 포인트 {calculate_point_from_history(cartoon_info, order_history)}점\n \n"  # 출력 결과 추가하기
    return result
